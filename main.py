...
def main(args):
    ...
    questions = [
        inquirer.List("type", message="Choice type",
    ...
    if answers['type'] in ["DCT", "DWT"]:
        ...
        questions = [
            inquirer.List("option", message="Choice option",
        ...
        questions = [
            inquirer.List("action", message="Choice action", choices=[
                "blur", "rotate180", "rotate90", "chop30",
                "gray", "randline", "cover", "brighter10", "darker10",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--origin", default="./images/cover.jpg", help="origin image file")
    parser.add_argument(
        "--watermark", default="./images/watermark.jpg", help="watermark image file")

    parser.add_argument(
        "--output", default="./images/watermarked.jpg", help="embedding image file")
